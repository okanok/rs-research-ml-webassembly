...
class Layer:
    ...
    #- Propaga te gradients through itself:    grad_input = layer.backward(input, grad_output)
...
def load_dataset(flatten=False):
    ...
    Y_train, Y_test, X_train, X_test = Y_train.values, Y_test.values, X_train.values, X_test.values
    # normalize x
